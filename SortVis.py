...
def draw_list(draw_info,color_positions = {} , clear_bg = False):
    ...
    if clear_bg:
        clear_rect = (DrawInformation.SIDE_PAD//2,draw_info.TOP_PAD , draw_info.width - DrawInformation.SIDE_PAD , draw_info.height - draw_info.TOP_PAD)
...
def main():
    ...
    n = 150     #Number of bars
    min_val = 0
    max_val = 100

    lst = generate_starting_list(n,min_val,max_val)
    draw_info = DrawInformation(1800,800,lst)     #(width,height,lst) 
    sorting = False
    ascending = True
